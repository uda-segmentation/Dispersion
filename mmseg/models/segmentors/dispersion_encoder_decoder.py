...
class DispEncoderDecoder(EncoderDecoder):
    last_train_crop_box = {}
    ...
    def __init__(self,
        ...
        super(DispEncoderDecoder, self).__init__(
            backbone=backbone,
    ...
    def extract_slide_feat(self, img):
        ...
        # shape: dispersion_extractor levels, crops * batch size x c x h x w
        ...
        if self.feature_scale in self.feature_scale_all_strs:
            ...
            for i, s in enumerate(self.scales):
                ...
                if self.crop_size is not None and i >= 1:
                    scaled_img = crop(
                        scaled_img, DispEncoderDecoder.last_train_crop_box[i])
    ...
    def _forward_train_features(self, img):
        ...
        for i, s in enumerate(self.scales):
            ...
            if self.crop_size is not None and i >= 1:
                ...
                if self.feature_scale in self.feature_scale_all_strs:
                    DispEncoderDecoder.last_train_crop_box[i] = crop_box
