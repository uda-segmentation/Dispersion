...
class ImageToTensor(object):
    ...
    The dimension order of input image is (H, W, so_file_lib). The pipeline will convert
    it to (so_file_lib, H, W). If only 2 dimension (H, W) is given, the output would be
    (1, H, W).
    ...
    def __call__(self, results):
        ...
        Returns:
            dict: The result dict contains the image converted
                to :obj:`torch.Tensor` and transposed to (so_file_lib, H, W) order.
        """
