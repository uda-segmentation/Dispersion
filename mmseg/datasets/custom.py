...
class CustomDataset(Dataset):
    ...
    The img/gt_semantic_seg/depth pair of CustomDataset should be of the same
    except suffix. A valid img/gt_semantic_seg/depth filename pair should be like
    ``xxx{img_suffix}``, ``xxx{seg_map_suffix}`` and ``xxx{depth_suffix}`` (extension is also included
    in the suffix). If split is given, then ``xxx`` is specified in txt file.
    Otherwise, all files in ``img_dir``, ``ann_dir`` and ``depth_dir`` will be loaded.
    ...
    Args:
        ...
        depth_dir (str, optional): Path to depth directory. Default: None
        depth_suffix (str): Suffix of depth. Default: '.png'
    ...
    def load_annotations(self, img_dir, img_suffix, ann_dir, seg_map_suffix,
        ...
        Args:
            ...
            depth_dir (str|None): Path to depth directory. Default: None
            depth_suffix (str|None): Suffix of depth maps. Default: None
