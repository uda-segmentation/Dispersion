...
# Default HRDA Configuration for Synthia->Cityscapes
_base_ = [
    '../_base_/default_runtime.py',
    # DAFormer Network Architecture
    '../_base_/models/daformer_sepaspp_mitb5.py',
    # Synthia->Cityscapes High-Resolution Data Loading
    '../_base_/datasets/uda_synthiaHR_to_cityscapesHR_disp_1024x1024.py',
...
# HRDA Configuration
model = dict(
    type='DispEncoderDecoder',
    decode_head=dict(
        type='DispHead',
        # Use the DAFormer decoder for each scale.
        single_scale_head='DispDAFormerHead',
        attention_head='DAFormerHead',
...
uda = dict(
    dispersion=dict(
        crop_size=(1024, 1024),
        so_path='dispersion_extractor/so_file_lib/libdispersion_extractor_hr.so',
        pretrained_checkpoint="pretrained/synthia_auxiliary.pth",
        alpha_agreement_multiplier=1.2,
        beta_disagreement_multiplier=0.3,
    ),
)
...
name = 'synthiaHR2csHR_hrda_disp_s1'
exp = 'basic'
name_dataset = 'synthiaHR2cityscapesHR_disp_1024x1024'
